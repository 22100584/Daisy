...
class UpdateSmallInfo extends StatefulWidget {
  const UpdateSmallInfo(
      {Key? key, required this.shareId, required this.smallId})
      : super(key: key);
  final String shareId;
  final String smallId;
  @override
  State<UpdateSmallInfo> createState() => UpdateSmallInfoState();
}

class UpdateSmallInfoState extends State<UpdateSmallInfo> {
  @override
  Widget build(BuildContext context) {
    bigInfoId = widget.shareId;
    smallId = widget.smallId;
